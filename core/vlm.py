...
class VLMInference:
    ...
    def generate_response(self, messages: list = None, system_prompt: str = None, image_input: str = None) -> str:
        """
        ...
        # Invoke the VLM
        response = self.vlm.invoke(message_list)

        return response.content

    def stream_response(self, messages: list = None, system_prompt: str = None, image_input: str = None):
        """
        ...
        for chunk in self.vlm.stream(message_list):
